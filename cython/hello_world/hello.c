 ...
 *     print("Hello %s1" % name)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyString_FormatSafe(__pyx_kp_s_Hello_s1, __pyx_v_name); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Hello_s1, __pyx_k_Hello_s1, sizeof(__pyx_k_Hello_s1), 0, 0, 1, 0},
